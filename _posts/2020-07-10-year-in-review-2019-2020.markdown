...
For about a month I was obsessed Codewars, and I have written a [blog post]({% post_url 2020-05-06-learning-from-codewars %}) on this. Completing katas on this platform greatly improved my problem solving skills and familiarity with Python and JavaScript.

## Blogging

In May, I finally created this blog and I am determined to update it regularly so that my next year-in-review blogpost will not have to be as lengthy as this one.

## Flutter and Dart

The creation and deployment of mobile apps has always a curiosity of mine, and I have written a [short blog post]({% post_url 2020-06-01-fluttering-and-darting %}) on this. My key learning from the short Flutter development course was asynchronous programming and state management.
...
Details of my setup process span four blog posts, starting from [this one]({% post_url 2020-06-23-pi-clustering-hardware %}).
