...
It is worth mentioning that [JuliaAcademy](https://juliaacademy.com/) is a good free resource, and there is also a course on Coursera called [Julia Scientific Programming](https://www.coursera.org/learn/julia-programming).
