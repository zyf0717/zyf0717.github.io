...
My [previous post]({% post_url 2020-08-18-apache-web-server-gcp %}) on setting up a Google Cloud Platform (GCP) virtual machine (VM) was one of the few times I ever used GCP. 
