...
A keyboard, mouse, a monitor, a HDMI cable as well as a Mini HDMI to HDMI adapter was also used for software setup in the next post of this series: [Pi Cluster (SSH and Static IP)]({% post_url 2020-06-24-pi-ssh-ip %}).
